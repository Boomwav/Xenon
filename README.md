![DownloadCount](https://img.shields.io/github/downloads/Boomwav/Xenon/total.svg)
# Xenon
...
## Installation
- Download the latest packaged `pthm` theme file from the [Releases page](https://github.com/darklinkpower/Helium/releases/latest) and open it.
